...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                // chiunque (autenticato o no) può accedere alle pagine home, login, register, ai css e alle immagini
                .antMatchers(HttpMethod.GET, "/**", "/home", "/login", "/register", "/css/**", "/images/**").permitAll()
                // chiunque (autenticato o no) può mandare richieste POST al punto di accesso per login e register 
                .antMatchers(HttpMethod.POST, "/login", "/register","/home","/cerca").permitAll()
                ...
                .logoutRequestMatcher(new AntPathRequestMatcher("/logout"));		//verificare se è questa la posizione giusta di questa chiamata
    }
